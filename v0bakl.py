...
rects =[]
logg=['ZXOPR运行！']
for i in sheetlocation['pageSheets'][1]['sections']:
    '''
    {
            'pTop': 0,
    ...
    '''
    try:
        print(i['type'],i['position'],i['contents']['branch'][0]['ixList'])
        addtext='\n'
...
drawkuangkuang_v1.draw_rectangles_on_canvas(rects, save_path='ssw.jpg', show=False)
pillowdrawtext('ssw.jpg',logg, font_size=8)
